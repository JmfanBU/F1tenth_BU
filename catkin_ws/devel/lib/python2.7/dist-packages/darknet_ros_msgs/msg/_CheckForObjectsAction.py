...
class CheckForObjectsAction(genpy.Message):
  _md5sum = "f96b42fed6fde15b18d58d29653a824c"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_h().pack(self.action_result.result.id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_result.result.id,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
